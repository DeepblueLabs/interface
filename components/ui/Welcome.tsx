...
export const WelcomeButton = ({ message }: IButtonProps) => {
  return (
    ...
    <>
      <motion.button
        className={classNames("px-8 py-3 bg-mint-green hover:bg-blue-400 text-white rounded-lg shadow-md text-sm", font.className)}
...
export const Welcome = ({ children }: IHeroProps) => {
  return (
    <div className="flex flex-col justify-center items-center h-[80vh] py-2">
      {children}
    </div>
  );
};
